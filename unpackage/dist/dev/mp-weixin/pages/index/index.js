  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return common_vendor.e({
        ...
        e: common_vendor.o(($event) => searchData.value = $event),
        f: common_vendor.p({
        ...
        h: common_vendor.o(onTabsChange),
        i: common_vendor.p({
        ...
        q: common_vendor.o(($event) => price.value = $event),
        r: common_vendor.p({
          ["active-color"]: "#ee0a24",
          min: 0,
          max: 100,
        ...
        v: common_vendor.o(onClosePopup),
        w: common_vendor.o(($event) => show.value = $event),
        x: common_vendor.p({
          position: "top",
          show: show.value
        }),
