...
VantComponent({
  ...
  methods: {
    observeValue() {
      ...
      this.setData({
        currentValue: this.format(value).newValue
      });
    },
    check() {
      const {
        newValue
      } = this.format(this.data.currentValue);
    ...
    format(value) {
      ...
      // format decimal
      const newValue = isDef(this.data.decimalLength) ? rangeValue.toFixed(this.data.decimalLength) : String(rangeValue);
      return {
        value,
        newValue
      };
    ...
    emitChange(data) {
      ...
      if (!this.data.asyncChange) {
        ...
        this.setData({
          currentValue: +value === +newValue ? value : newValue
        });
      }
